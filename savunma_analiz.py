...
# Nesne isimlerini Türkçeleştirmek için sözlük
TR_NAMES = {
    "person": "Personel",
    "bicycle": "Bisiklet",
    "car": "Araç",
...
st.info("Bu platform, YOLOv8 derin öğrenme mimarisini kullanarak görüntü üzerinden otonom hedef tespiti gerçekleştirir.")
...
if uploaded_file is not None:
    ...
    if len(found_objects) > 0:
        ...
        for box in found_objects:
            ...
            # İngilizce sınıf ismini sözlükten Türkçe karşılığına çeviriyoruz
            ...
            with st.expander(f"HEDEF DETAYI: {name_tr} (Güven: %{conf*100:.1f})"):
                ...
                # Akıllı Karar Destek Açıklamaları
                if raw_name == "airplane":
                    ...
                    st.write("🔍 ANALİZ: Standart sınıflandırma yapıldı. Ek istihbarat verisi bekleniyor.")
    else:
        st.error("Herhangi bir stratejik hedef saptanamadı. Lütfen 'Algılama Hassasiyeti' ayarını kontrol edin.")
# Alt Bilgi
st.sidebar.markdown("---")
st.sidebar.write("💻 **Teknik Altyapı:** YOLOv8-Nano Modeli")
st.sidebar.write("🛠️ **Durum:** Operasyonel")